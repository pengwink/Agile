/*
 * @Author: Pengwink
 * @Date: 2024-01-23 16:16:05
 * @LastEditTime: 2024-01-24 17:03:20
 * @LastEditors: Pengwink
 * @Description:
 * @FilePath: \AgileBoot-Front-End\src\utils\auth.ts
 * 版权声明
 */
...
export function setTokenFromBackend(data: TokenDTO): void {
  ...
  useUserStoreHook().SET_PERMISSIONS(data.currentUser.permissions);
